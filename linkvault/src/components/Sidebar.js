...
const Sidebar = () => {
  ...
  const sidebarItems = [
    { path: '/dashboard', icon: <PresentationChartBarIcon className="w-5 h-5" />, label: 'Dashboard' },
    { path: '/inbox', icon: '...', label: 'Inbox', badge: 3 },
    { path: '/users', icon: '...', label: 'Users' },
    { path: '/products', icon: '...', label: 'Products' },
    { path: '/logout', icon: '...', label: 'Log Out' },
  ];
              ...
              <li key={index}>
                <Link
                  ...
                  className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                    location.pathname === item.path ? 'bg-blue-200 dark:bg-blue-800' : ''
                  }`}
                >
                  {item.icon}
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
            <Link
            to="/dashboard"  // Specify the correct path for your dashboard
            className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <svg
            ...
            <li>
            <Link to="/another-path" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
